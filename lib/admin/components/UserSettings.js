...
export default class UserSettings extends Component<Props, State> {
  ...
  render () {
        ...
        header={
          <h3>
            ...
            <SplitButton
              ...
              title={currentProject ? currentProject.name : 'No hay proyectos disponibles'}
              id={currentProject ? currentProject.name : 'No hay proyectos disponibles'}
    ...
    return (
      <Row>
        <Col xs={4}>
          <Panel header={<h3>Configuración de la organización</h3>}>
