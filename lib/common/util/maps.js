...
/*  if ( process.env.MAPTYPE === "OSM" )
  ...
  //here we use only OSM
/*  const attribution = `<a href="https://www.mapbox.com/about/maps/" target="_blank">&copy; OSM &copy; OpenStreetMap</a> <a href="https://www.mapbox.com/map-feedback/" target="_blank">Improve this map</a>`
