...
export function defaultTileLayerProps (mapId: ?string): TileLayerProps {
  if ( process.env.MAPTYPE == "OSM" )
  {
  const attribution = process.env.MAPBOX_ATTRIBUTION || `<a href="https://www.mapbox.com/about/maps/" target="_blank">&copy; OSM &copy; OpenStreetMap</a> <a href="https://www.mapbox.com/map-feedback/" target="_blank">Improve this map</a>`
