      ...
      <Row>
        ...
        <Col xs={9}>
          {feedSource.editorSnapshots && feedSource.editorSnapshots.length
            ? <div>
              ...
              <Panel bsStyle='success' header={<h3>Snapshots disponibles</h3>}>
                <ListGroup fill>
                  {snapshots.length === 0
                    ? <ListGroupItem>No hay otros snapshots</ListGroupItem>
                    : snapshots.map(s => {
                      return (
                        <SnapshotItem
        ...
        <Col xs={3}>
          ...
          <Button
            ...
            <Icon type='camera' /> Crear snapshot de los últimos cambios
          </Button>
          <Panel
            header={
              <h3>
      ...
      <ListGroupItem>
        ...
        <div>
          ...
          <p
            ...
            {moment(snapshot.snapshotTime).format('DD/MM/YYYY hh:mm:ss')}
          </p>
          {snapshot.comment
            ? <p
              className='list-group-item-text'
