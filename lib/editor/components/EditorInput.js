    ...
    switch (field.inputType) {
      ...
      case 'GTFS_ROUTE_NETWORK':
        ...
        if (activeComponent === 'route' &&
            activeEntity &&
            activeEntity.route_network_ids &&
            typeof activeEntity.route_network_ids === 'string') {
          routeNetworkIds = activeEntity.route_network_ids.split('§').filter(Boolean)
        }
        return (
          <FormGroup {...formProps}>
            {basicLabel}
