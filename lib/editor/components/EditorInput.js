...
import {doesNotExist} from '../util/validation/validation'
import GtfsServiceSelect from '../../common/components/GtfsServiceSelect'
...
import type {Entity, Feed, GtfsAgency, GtfsLocation, GtfsRoute, GtfsSpecField, GtfsStop} from '../../types'
...
import GenericEntitySelector from './EntitiySelector'
...
export default class EditorInput extends React.Component<Props> {
  ...
  _onHourMinuteInputChange = (seconds: number) => {
    this._processFieldChange(seconds / 60) // Maintain the state in minutes, since that is what the field type is.
  }
  ...
  render () {
    ...
    switch (field.inputType) {
      ...
      // TODO: fare_product and fare_media could likely be refactored to use the GenericEntitySelector component.
      ...
      case 'GTFS_STOP_AREA':
        // FARE-TODO: add area selector for fare_leg_rule editing
        ...
        return (
          <FormGroup {...formProps}>
            ...
            <GenericEntitySelector
              ...
              disabled={routeNetworkDisabled}
              entities={networks}
              genericEntityName='route network'
              processFieldChange={this._processFieldChange}
            />
          </FormGroup>
        )
