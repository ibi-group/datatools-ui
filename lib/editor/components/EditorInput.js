  ...
  render () {
    ...
    switch (field.inputType) {
      ...
      case 'GTFS_SERVICE_DROPDOWN': {
        // For the GTFS Service in booking rules, use a searchable select like TIMEZONE_SELECT
      ...
      case 'URL': {
        ...
        return activeComponent === 'bookingrule' ? elements : <span>{elements}</span> // TODO: if we're sure that removing the span doesn't affect anything elsewhere remove this condition.
      }
      case 'GTFS_ZONE':
