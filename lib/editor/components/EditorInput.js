    ...
    switch (field.inputType) {
      ...
      case 'GTFS_ROUTE_NETWORK':
        ...
        if (activeComponent === 'route') {
          ...
          console.log('route for route network selector', route)
          if (route.networkId !== undefined || route.network_id !== null) {
            console.log('disabling route network selector because route has network_id populated', route)
