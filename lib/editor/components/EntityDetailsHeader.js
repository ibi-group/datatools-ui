      ...
      <div className='entity-details-header'>
          ...
          <ButtonGroup className='pull-right'>
            {activeComponent === 'stop' || activeComponent === 'route'
              ? <OverlayTrigger
                rootClose
                placement='bottom'
                overlay={<Tooltip id='tooltip'>Acercar a {activeComponent}</Tooltip>}>
                <Button
                  bsSize='small'
            ...
            <OverlayTrigger
              rootClose
              placement='bottom'
              overlay={<Tooltip id='tooltip'>Deshacer cambios</Tooltip>}>
              <Button
                bsSize='small'
            ...
            <OverlayTrigger
              rootClose
              placement='bottom'
              overlay={<Tooltip id='tooltip'>Guardar cambios</Tooltip>}>
              <Button
                bsSize='small'
        ...
        <p style={{marginBottom: '2px'}}>
          <small style={{marginTop: '3px'}} className='pull-right'>
            <em className='text-muted'>* denota campo obligatorio</em>
          </small>
          <small
              ...
              ? <span>
                ...
                <OverlayTrigger
                  ...
                  <span style={{borderBottom: '1px dotted #000'}}>
                    {validationErrors.length} problema(s) de validación
                  </span>
                </OverlayTrigger>
              </span>
              : <span><Icon type='check-circle' /> No hay problemas de validación</span>
            }
          </small>
        </p>
        ...
        {activeComponent === 'route'
          ? <Nav style={{marginBottom: '5px'}} bsStyle='pills' justified>
            ...
            <OverlayTrigger placement='bottom' overlay={<Tooltip id='tooltip'>Los patrones de viaje definen las secuencias de paradas y los tiempos únicos de una ruta.</Tooltip>}>
              <NavItem
                active={subComponent === 'trippattern'}
