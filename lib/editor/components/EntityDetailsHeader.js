      ...
      <div className='entity-details-header'>
        ...
        {activeComponent === 'route'
          ? <Nav style={{marginBottom: '5px'}} bsStyle='pills' justified>
            ...
            <OverlayTrigger placement='bottom' overlay={<Tooltip id='tooltip'>Les motifs de voyage définissent une séquence d'arrêts et d'horaires unique associée à un itinéraire.</Tooltip>}>
              <NavItem
                active={subComponent === 'trippattern'}
