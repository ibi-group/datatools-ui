...
import FaresV2FileSelector from './FaresV2FileSelector'
...
import {getEntityName, getTableById, isComponentFaresv2} from '../util/gtfs'
  ...
  render () {
    ...
    const entityDetails = activeEntityId
      ? <EntityDetails
        ...
        {...this.props} />
      : null
    const faresV2FileSelector = isComponentFaresv2(activeComponent) &&
      <FaresV2FileSelector
        activeComponent={activeComponent}
        feedSource={feedSource}
        key='fares-v2-file-selector'
