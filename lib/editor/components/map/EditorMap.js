...
export default class EditorMap extends Component<Props, State> {
  ...
  componentDidMount () {
    window.addEventListener('resize', this._scheduleMapResize)
  ...
  componentWillUnmount () {
    window.removeEventListener('resize', this._scheduleMapResize)
  }
  ...
  render () {
    ...
    const { zoomToTarget, willMount } = this.state
