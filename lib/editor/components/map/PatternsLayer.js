        ...
        <Tooltip
          ...
          <span>
            {dragEnabled && isEditing
              ? `Haga clic para ${editingSegment ? clickAction : 'editar segmento'}`
              : dragEnabled
                ? `${pattern.name} (Haga clic para ${clickAction})`
                : 'El arrastre está deshabilitado. Cambia al modo de edición primero.'
            }
          </span>
        </Tooltip>
      </Polyline>
