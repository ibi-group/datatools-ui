      ...
      <div>
        ...
        <FormControl
          ...
          onChange={(evt) => {
            ...
            updateEditSetting({setting: 'followStreets', value: evt.target.value === SNAP_TO_OPTIONS.STREET})
            updateEditSetting({setting: 'followRail', value: evt.target.value === SNAP_TO_OPTIONS.RAIL})
          }}>
