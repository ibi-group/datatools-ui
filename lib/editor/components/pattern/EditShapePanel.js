...
import type {ControlPoint, LatLng, Pattern, GtfsRoute, GtfsStop, GtfsLocation} from '../../../types'
  ...
  _deleteShape = () => {
    ...
    showConfirmModal({
      ...
      onConfirm: () => {
        ...
        updatePatternGeometry(generateControlPointsFromPatternStops(activePattern.patternStops, stops, locations, locationGroups))
        updateActiveGtfsEntity({
          component: 'trippattern',
          entity: activePattern,
