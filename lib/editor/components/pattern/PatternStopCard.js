...
const pickupDropoffOptions = [
  ...
  {
    value: 1,
    text: 'No disponible (1)'
  },
  {
    value: 2,
    text: 'Debe llamar a la agencia para coordinar (2)'
  },
  {
    value: 3,
    text: 'Debe coordinar con el conductor para organizar (3)'
  }
]
        ...
        <Row>
            ...
            <FormGroup
              ...
              <ControlLabel
                title={this.props.index === 0
                  ? 'El tiempo de viaje para la primera parada debe ser cero'
                  : 'Defina el tiempo predeterminado que se tarda en viajar a esta parada desde la parada anterior.'
                }
                className='small'>Tiempo de viaje predeterminado</ControlLabel>
              <MinuteSecondInput
          ...
          <Col xs={6}>
            <FormGroup
              ...
              bsSize='small'>
              <ControlLabel className='small'>Tiempo de espera predeterminado</ControlLabel>
              <MinuteSecondInput
        ...
        <Row>
          <Col xs={6}>
            <PickupDropoffSelect
              ...
              title='Defina el método de recogida/disponibilidad en esta parada.'
          ...
          <Col xs={6}>
            <PickupDropoffSelect
              ...
              shouldHaveDisabledOption={false}
              title='Defina el método de llegada/disponibilidad en esta parada.'
        ...
        <Row>
          <Col xs={6}>
            <PickupDropoffSelect
              ...
              shouldHaveDisabledOption
              title='Indica si un pasajero puede abordar el vehículo de tránsito en cualquier lugar a lo largo de la ruta de viaje del vehículo.'
          ...
          <Col xs={6}>
            <PickupDropoffSelect
              ...
              shouldHaveDisabledOption
              title='Indica si un pasajero puede bajarse del vehículo de tránsito en cualquier punto a lo largo de la ruta de viaje del vehículo.'
