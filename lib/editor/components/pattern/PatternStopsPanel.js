      ...
      <div>
        ...
        <div style={{width: '100%'}}>
          ...
          <Button
            ...
            bsSize='small'>
            {addStops
              ? <span><Icon type='times' /> Cancelar</span>
              : <span><Icon type='plus' /> Añadir parada</span>
            }
          </Button>
          <small className='pull-right' style={{margin: '5px'}}>
            {addStops && mapState.zoom && mapState.zoom <= 14
              ? 'Zoom para ver las paradas'
              : `Añadir paradas a través del mapa`
            }
          </small>
        </div>
        ...
        <div id='pattern-stop-list-header'>
          <div className='pull-left' style={{width: '50%'}}>
            <p className='small' style={{marginBottom: '0px'}}>
              <strong>Secuencia de parada</strong>
            </p>
          </div>
        ...
        <div style={{marginTop: '10px'}}>
          {addStops
            ...
            : <Button
              ...
              onClick={this._toggleAddStopsMode}
            >
              <Icon type='plus' /> Agregar parada por nombre
            </Button>
          }
        </div>
      </div>
