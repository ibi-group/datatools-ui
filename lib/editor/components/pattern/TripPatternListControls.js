...
export default class TripPatternListControls extends Component<Props> {
  ...
  _onClickDeletePattern = () => {
    ...
    showConfirmModal({
      title: `Supprimer cette circulation ?`,
      body: `Êtes-vous sûr de vouloir supprimer cette circulation ? Cela supprimera tous les trajets associés.`,
      onConfirm: () => {
      ...
      confirmButtonText: 'Supprimer la circulation'
    })
  }
  ...
  _onClickReversePattern = () => {
    ...
    showConfirmModal({
      title: `Inverser la circulation ?`,
      body: `Êtes-vous sûr de vouloir inverser la circulation ?`,
      onConfirm: () => {
    ...
    return (
      <div className='trip-pattern-controls'>
        <ButtonGroup
          ...
          <OverlayTrigger
            ...
            <Button
              ...
              title={patternHasTrips
                ? 'Impossible d\'inverser une circulation qui a des trajets.'
                : 'Sélectionner une circulation à inverser'}
          ...
          <OverlayTrigger
            placement='bottom'
            overlay={<Tooltip id='tooltip'>Dupliquer la circulation</Tooltip>}>
            <Button
              bsSize='small'
          ...
          <OverlayTrigger
            placement='bottom'
            overlay={<Tooltip id='tooltip'>Supprimer la circulation</Tooltip>}>
            <Button
              bsSize='small'
        ...
        >
          <Icon type='plus' /> Nouvelle circulation
        </Button>
      </div>
    )
  }
