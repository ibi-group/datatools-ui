...
export default class TripPatternListControls extends Component<Props> {
  ...
  _onClickDeletePattern = () => {
    ...
    showConfirmModal({
      title: `¿Eliminar patrón de viaje?`,
      body: `¿Está seguro de que desea eliminar este patrón de viaje? Esto eliminará todos los viajes asociados con este patrón.`,
      onConfirm: () => {
      ...
      confirmButtonText: 'Eliminar patrón'
    })
  }
  ...
  _onClickReversePattern = () => {
    ...
    showConfirmModal({
      title: `¿Patrón de viaje inverso?`,
      body: `¿Está seguro de que desea invertir este patrón de viaje?`,
      onConfirm: () => {
    ...
    return (
      <div className='trip-pattern-controls'>
        <ButtonGroup
          ...
          <OverlayTrigger
            placement='bottom'
            overlay={<Tooltip id='tooltip'>Patrón de viaje inverso</Tooltip>}>
            <Button
              bsSize='small'
              title={patternHasTrips
                ? 'No se pueden revertir patrones que tienen viajes'
                : 'Seleccione el patrón para invertir'}
          ...
          <OverlayTrigger
            placement='bottom'
            overlay={<Tooltip id='tooltip'>Patrón de viaje duplicado</Tooltip>}>
            <Button
              bsSize='small'
          ...
          <OverlayTrigger
            placement='bottom'
            overlay={<Tooltip id='tooltip'>Eliminar patrón de viaje</Tooltip>}>
            <Button
              bsSize='small'
