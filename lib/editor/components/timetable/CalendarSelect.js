    ...
    return (
      <span title={title}>
        ...
        <BsLabel
          ...
          title={`El calendario tiene ${patternTrips} viajes para el patrón`}>
        ...
        {' '}
        <BsLabel
          title={`El calendario tiene ${patternTrips} viajes para este Feed`}>
  ...
  render () {
    ...
    return (
      <Select
        ...
        placeholder={<span><Icon type='calendar-o' /> Seleccionar calendario...</span>}
