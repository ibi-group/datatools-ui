...
export default class TimetableEditor extends Component<Props, State> {
  ...
  removeSelectedRows = () => {
    ...
    showConfirmModal({
      ...
      body: `¿Está seguro de que desea eliminar de forma permanente ${selectedCount} viaje${selectedCount > 1 ? 's' : ''}?`,
      confirmButtonStyle: 'danger',
      confirmButtonText: 'Eliminar viajes',
      onConfirm: () => {
        const indexes = []
        const tripsToDelete = []
      ...
      <div
        ...
        {activeSchedule
          ...
          : <p className='lead text-center'>
            {activePattern
              ? <span>
                Elija un calendario para editar horarios o
                {' '}
                <Button
                  bsStyle='success'
              ...
              : <span>Elija un patrón de viaje.</span>
            }
          </p>
        }
      </div>
