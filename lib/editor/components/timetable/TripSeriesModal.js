    ...
    <Modal show={show} onHide={onClose}>
      ...
      <Body>
        ...
        <div style={{
          ...
          {messages('startTime')} <div><HourMinuteInput onChange={input => setState((prevState) => ({ ...prevState, startTime: input }))} seconds={startTime} standaloneInput showSeconds={false} /></div>
          {messages('headway')} <div><HourMinuteInput onChange={input => setState((prevState) => ({ ...prevState, headway: input }))} seconds={headway} standaloneInput showSeconds={false} /></div>
          {messages('endTime')} <div><HourMinuteInput onChange={input => setState((prevState) => ({ ...prevState, endTime: input }))} seconds={endTime} standaloneInput showSeconds={false} /></div>
        </div>
        <hr />
        <div>
