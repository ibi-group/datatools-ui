...
import {getActivePatternLocations, getActivepatternLocationGroupStops, getActivePatternStops, getControlPoints, getValidationErrors} from '../selectors'
...
const mapStateToProps = (state: AppState, ownProps: Props) => {
  ...
  const activepatternLocationGroupStops = getActivepatternLocationGroupStops(state)
  return {
    activeComponent,
    activeEntity,
    activeEntityId,
