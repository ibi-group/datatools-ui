...
export function mergePatternHalts (
  ...
  return [...patternLocations, ...patternLocationGroupStops, ...patternStops]
    .sort((a, b) => a.stopSequence - b.stopSequence)
}
export function mergePatternHaltsOfPattern (pattern: Pattern) {
  return mergePatternHalts(pattern.patternStops, pattern.patternLocations, pattern.patternLocationGroupStops)
}
