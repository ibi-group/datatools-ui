      ...
      <Row>
        ...
        <Col xs={12} sm={8}>
          ...
          {isExtensionEnabled('mtc') && (
            <Panel header={<h3>Publicación automática</h3>}>
              <ListGroup fill>
                <ListGroupItem>
                  <FormGroup>
                    <Checkbox
                    ...
                    >
                      <strong>Publicar automáticamente este feed</strong>
                    </Checkbox>
                    <small>
                      Configurar este Feed source para que se publique automáticamente
