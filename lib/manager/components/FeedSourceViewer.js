...
export default class FeedSourceViewer extends Component<Props> {
  ...
  confirmDeleteFeedSource = () => {
    ...
    this.refs.page.showConfirmModal({
      ...
      body: '¿Está seguro de que desea eliminar este Feed Source? Esta acción no se puede deshacer y se eliminarán todas las versiones del Feed.',
      ...
      return (
        <ManagerPage ref='page'>
          <Grid fluid>
            <Row>
              <Col xs={12}>
                <p>No se ha encontrado Feed Source para <strong>{this.props.feedSourceId}</strong></p>
                <p><Link to='/project'>Regresar a la lista de proyectos</Link></p>
              </Col>
            </Row>
          </Grid>
        </ManagerPage>
