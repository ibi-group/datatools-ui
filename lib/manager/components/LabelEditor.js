  ...
  render () {
    ...
    return (
      <Form onChange={(e) => this._onFormChange(e)}>
                ...
                {isProjectAdmin && (
                  <Col xs={9}>
                    <Checkbox
                      ...
                      style={{ margin: 0 }}
                    >
                      <strong>¿Solo visible para administradores?</strong>
                    </Checkbox>
                    <div style={{marginTop: 5}}>
                      Si está seleccionado, esta etiqueta solo será visible para los administradores de proyectos y aplicaciones.
                    </div>
                  </Col>
                )}
              </Row>
        ...
        <Modal.Footer>
          {/* Cancel button */}
          <Button onClick={this.props.onDone} style={{ marginRight: 10 }}>Cancelar</Button>
          {/* Save button */}
          <Button
            bsStyle='primary'
