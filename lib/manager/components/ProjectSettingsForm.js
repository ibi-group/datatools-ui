...
export default class ProjectSettingsForm extends Component<Props, State> {
  ...
  _onDeleteProject = () => {
    ...
    if (!deleteProject) {
      throw new Error('Al componente ProjectSettingsForm falta la acción deleteProject')
    }
    // cast to make flow happy
  ...
  _onOpenMapBoundsModal = () => {
    ...
    this.refs.mapModal.open({
      title: 'Seleccione los límites del proyecto',
      body: `Imagina que esto es un mapa`,
      bounds: bounds,
    ...
    if (editDisabled) {
      return (
        <p className='lead text-center'>
          ...
          No tienes permiso para editar los detalles de esta fuente de feed.
        </p>
      )
    }
    return (
      <div>
          ...
          <ListGroup fill>
            <ListGroupItem>
              <FormGroup
                ...
                <HelpBlock>Obligatorio.</HelpBlock>
              </FormGroup>
            </ListGroupItem>
          </ListGroup>
        </Panel>
        ...
        <Panel header={<h4>Índice de Lugares Locales</h4>}>
          <ListGroup fill>
            <ListGroupItem>
          ...
          <Panel bsStyle='danger' header={<h3>Zona peligrosa</h3>}>
            <ListGroup fill>
              <ListGroupItem>
                ...
                >
                  <Icon type='trash' /> Eliminar proyecto
                </Button>
                <h4>Eliminar este proyecto.</h4>
                <p>Una vez que elimina un proyecto, el proyecto y todas las Feed Sources que contiene no se pueden recuperar.</p>
              </ListGroupItem>
            </ListGroup>
          </Panel>
        }
