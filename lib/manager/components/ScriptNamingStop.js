    ...
    return (
      <ManagerPage
        ...
        <Grid fluid>
          ...
          <Row style={{ marginBottom: '20px' }}>
            <Col>
              <div style={{ padding: 10, backgroundColor: "#dddbdb" }}>
                <ol>
                  <li>
                    <strong>Cargar Archivo</strong>: 
                      Comienza cargando tu archivo shapefile. 
                      Asegúrate de que el archivo contenga geometrías de puntos, ya que son los únicos tipos de geometrías que esta herramienta puede procesar. 
                      Los datos deben de tener la proyección <strong>EPSG:4326</strong>.
                  </li>
                  <li>
                    <strong>Nombrar paradas</strong>: Una vez cargado el archivo, podrás agregar nombres de calles a cada punto.
                  </li>
                  <li>
                    <strong>Descargar resultados</strong>: Tras completar la asignación de nombres, podrás descargar el shapefile modificado. El nombre modificado se guardara en la propiedad de <strong>'Name'</strong> sobreescribiendo cualquier valor
                  </li>
                </ol>
              </div>
            </Col>
