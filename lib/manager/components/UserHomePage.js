        ...
        <Grid fluid>
          ...
          <Row>
            <Col md={8} xs={12}>
              ...
              <h3 style={{ marginTop: 20, paddingBottom: 5, borderBottom: '2px solid #ddd' }}>
                <Icon type='arrow-right' /> Script: Agregar nombres a una lista de paradas
              </h3>
              <ol>
                <li><a target='_self' rel='noopener noreferrer' href='/teston'>Visitar.</a></li>
              </ol>
            </Col>
            <Col md={4} xs={12}>
