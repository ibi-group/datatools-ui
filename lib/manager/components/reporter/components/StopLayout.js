          ...
          <Row style={{marginTop: 20}}>
            <Col xs={12}>
              <BootstrapTable
                ...
                <TableHeaderColumn dataSort dataField='stop_name' width='50%'>Nombre</TableHeaderColumn>
                <TableHeaderColumn dataSort dataField='stop_code'>Código de parada</TableHeaderColumn>
                <TableHeaderColumn dataSort dataField='zone_id'>ID de zona</TableHeaderColumn>
              </BootstrapTable>
            </Col>
          </Row>
        }
