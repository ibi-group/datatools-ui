          ...
          <ListGroup key={index} fill>
                ...
                <Col xs={12}>
                  <h4>
                    ...
                    <span className={errorClass}>
                      ...
                      caso{category.count > 1 ? 's' : ''} encontrado
                    </span>
                    {' '}
                    {isBlockingIssue &&
                      <BsLabel bsStyle='danger'>BLOQUEANDO</BsLabel>
                    }
            ...
            <Panel collapsible bsClass='' expanded={errorTypeIsActive}>
              ...
              <Table striped hover fill className='table-fixed'>
                <thead><tr>
                  <th>Línea #</th>
                  {includeEntityType && <th>Tipo de entidad</th>}
                  <th>{firstError && !includeEntityType ? firstError.entity_type : 'Entidad'} ID</th>
            ...
            {errorTypeIsActive &&
              ...
              : errorTypeIsActive
                ? <ListGroupItem className='validation-item'>
                  <span className='text-muted'>No más errores de este tipo</span>
                </ListGroupItem>
                : null
            }
          </ListGroup>
