        ...
        <td>
          <Button
            ...
            title={noFeedInEditor
              ? 'Importar feed al editor para solucionar el problema'
              : typeIsNotEditable
                ? 'El tipo de error no está vinculado al editor'
                : 'Arreglar en el editor'}
          ...
          <Button
            ...
            disabled={noEntityId}
            title={noEntityId ? `No hay entidad para ver` : `Ver ${type} detalles`}
            style={{margin: 0, padding: 0}}
            bsStyle='link'
          >
            <Icon type='info' />
