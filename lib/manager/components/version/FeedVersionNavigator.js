    ...
    return (
      <div>
        <SelectFileModal ref='uploadModal'
          ...
          errorMessage='El archivo subido debe ser un archivo zip válido (.zip).' />
                ...
                : <ButtonGroup> {/* Version Navigation/Selection Widget */}
                  ...
                  {versionSummaries.length > 0 &&
                    <VersionSelectorDropdown
                      ...
                      header='Seleccione una versión para ver el resumen'
                      title={dropdownTitle}
                      version={version}
              ...
              <ButtonToolbar className='pull-right'>
                ...
                <ButtonGroup>
                  {isModuleEnabled('deployment') && deploymentForVersion
                    ? <DeploymentPreviewButton
                      ...
                      project={project}>
                      Ver despliegue {version && version.id}
                    </DeploymentPreviewButton>
                    : null
                  }
                  {isModuleEnabled('deployment') && !isPublic
                    ? <Button
                      ...
                      <Icon type='globe' /> Desplegar feed
                    </Button>
                    : null
                  }
                  {isModuleEnabled('editor') && !isPublic
                    ? <LinkContainer to={`/feed/${feedSource.id}/edit`}>
                      <Button
                        ...
                        <Glyphicon glyph='pencil' /> Editar Feed
                      </Button>
                    </LinkContainer>
                    : null
                  }
                ...
                {!isPublic
                  ? <DropdownButton
                    ...
                    title={
                      <span>
                        <Icon type='plus' /> Crear nueva versión
                      </span>
                    }
                    ...
                    <MenuItem
                      ...
                      eventKey='snapshot'>
                      <Glyphicon glyph='camera' /> Desde snapshot
                    </MenuItem>
                  </DropdownButton>
                  : null
                }
