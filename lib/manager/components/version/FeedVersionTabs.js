    ...
    return (
      <ListGroupItem>
        ...
        <Tabs
          ...
          bsStyle='pills'
          unmountOnExit>
          <Tab eventKey={'feed'} title='Resumen'>
            <Row>
              {countFields.map(c => {
            ...
            <div style={{marginTop: '10px'}}>
              <Row>
                <Col xs={12}>
                  <p className='lead text-center'>Número de viajes por fecha.</p>
                </Col>
              </Row>
              <TripsChart validationResult={version.validationResult} />
              <Row>
                <Col xs={12}>
                  <p className='lead text-center'>Horas de servicio por fecha y modo.</p>
                </Col>
              </Row>
              <ServicePerModeChart validationResult={version.validationResult} />
            </div>
          </Tab>
          <Tab eventKey={'routes'} title='Rutas'>
            <Routes
              version={version}
          ...
          <Tab eventKey={'stops'} title='Paradas'>
            <Stops
              version={version}
              selectTab={this.props.selectTab}
              tableOptions={{...tableOptions, search: true}} />
          </Tab>
          <Tab eventKey={'timetables'} title='Horarios'>
            <Timetables
              version={version}
              selectTab={this.props.selectTab}
