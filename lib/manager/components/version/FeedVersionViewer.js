      ...
      <Panel>
        <ListGroup fill>
          <LinkContainer
            ...
            to={versionPath}
          >
            <ListGroupItem><Icon type='info-circle' /> Resumen de la versión</ListGroupItem>
          </LinkContainer>
          <LinkContainer
          ...
          >
            <ListGroupItem>
              <Icon type='exclamation-triangle' /> Problemas de validación {this._renderIssuesLabel()}
            </ListGroupItem>
          </LinkContainer>
          <LinkContainer
          ...
          >
            <ListGroupItem>
              <Icon type='exchange' /> Resultados de la transformación {this._renderTransformResultsCount(version)}
            </ListGroupItem>
          </LinkContainer>
          {isModuleEnabled('gtfsplus')
            ...
            >
              <ListGroupItem>
                <Icon type='plus' /> GTFS+ para esta versión {this._renderGtfsPlusIssuesLabel(version)}
              </ListGroupItem>
            </LinkContainer>
            : null
          }
          ...
          >
            <ListGroupItem>
              <Glyphicon glyph='comment' /> Comentarios de la versión{' '}
...
class VersionList extends Component<ListProps> {
  render () {
    ...
    return <Panel header={<h3>Lista de versiones del feed</h3>}>
      <ListGroup fill>
