    ...
    const ACCOUNT_SECTIONS = [
      {
        ...
        component: (
          <div>
            <Panel header={<h4>Información del perfil</h4>}>
              <ListGroup fill>
                <ListGroupItem>
                ...
                <ListGroupItem>
                  ...
                  <a href='http://gravatar.com'>
                    <img
                      ...
                      width={40}
                      src={profile.picture} />
                    <span style={{marginLeft: '10px'}}>Actualízalo en gravatar.com</span>
                  </a>
                </ListGroupItem>
                <ListGroupItem>
          ...
          <Row style={{marginBottom: '20px'}}>
            <Col xs={12}>
              <h1>
                ...
                <Icon type='user' /> Mi configuración
              </h1>
            </Col>
          </Row>
          <Row>
  ...
  render () {
    ...
    return <div>
      {projectSubscriptions && (
        <div>
          <h4><Icon type='eye' /> Proyectos seguidos</h4>
          {projectSubscriptions.target.length
            ...
            : <span>No hay proyectos seguidos actualmente</span>
          }
        </div>
      )}
      {feedSubscriptions && (
        <div style={{ marginTop: 30 }}>
          <h4><Icon type='eye' /> Feeds seguidos</h4>
          {feedSubscriptions.target.length
            ...
            : <span>No hay feeds seguidos actualmente</span>
          }
        </div>
      )}
      {deploymentSubscriptions && (
        <div style={{ marginTop: 30 }}>
          <h4><Icon type='eye' /> Despliegues seguidos</h4>
          {deploymentSubscriptions.target.length
            ...
            : <span>No hay despliegues seguidos actualmente</span>
          }
        </div>
      )}
    </div>
...
class WatchedProject extends Component<Props & {target: string}> {
  ...
  render () {
    ...
    const projectLink = project
      ...
      : <span style={{ fontStyle: 'italic', color: 'gray' }}>{target} (Eliminado)</span>
    return (
      <ListGroupItem>
        {projectLink}
        ...
        ><Icon type='eye-slash' /> No seguir</Button>
      </ListGroupItem>
    )
  }
}
