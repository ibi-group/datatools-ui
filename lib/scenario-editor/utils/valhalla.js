...
import { KeyRotator as graphHopperKeyRotatorFactory } from '../../api/graphHopper'

const graphHopperKeyRotator = new graphHopperKeyRotatorFactory( process.env.GRAPH_HOPPER_KEY ? process.env.GRAPH_HOPPER_KEY.split(","):"" )
...
export function routeWithGraphHopper (points: Array<LatLng>, avoidMotorways?: boolean): ?Promise<GraphHopperResponse> {
  ...
  let graphHopperKey = graphHopperKeyRotator.getKey()
