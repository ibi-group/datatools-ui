...
export type FeedSourceSummary = {
  ...
  deployedFeedVersionIssues?: number,
...
export type GtfsSpecFieldOption = {parentValue?: string, text: string, value: string}
...
export type GtfsSpecField = {
  activeComponentOverride?: string,
  adminOnly?: boolean,
  ...
  inputType: InputType,
  name: string,
  options?: Array<GtfsSpecFieldOption>,
  parent?: string,
  placeholder?: string,
  required: boolean
}
...
export type GtfsBookingRule = {
  ...
  prior_notice_duration_max: ?(number | string),
  prior_notice_duration_min: ?(number | string),
  prior_notice_last_day: ?(number | string),
  prior_notice_last_time: ?number,
  prior_notice_service_id: ?string,
  prior_notice_start_day: ?(number | string),
...
// FLEX TODO: Map support for location groups will require this type
